...
public class JDBIIdpSessionRepositoryTest {
	...
	private IdpSession createSession(IdaAuthnRequestFromHub authnRequestFromHub) {
		IdpSession session = new IdpSession(SessionId.createNewSessionId(), authnRequestFromHub, "test-relay-state", Arrays.asList(), Arrays.asList(), Optional.empty(), Optional.empty(), null);
