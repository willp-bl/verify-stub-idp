...
<div class="main">
    <div class="tabs">
        <ul>
            <li>
                <a id="tab-login" class="tab-text" href="/eidas/${idpId}/login.php">Login</a>
            </li>
    ...
    <form action="/eidas/${idpId}/register.php" class="register" method="post" id="registration-form" autocomplete="off">
        <fieldset>
