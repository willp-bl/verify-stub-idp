...
<div class="main">
    ...
    <form action="/${idpId}/login.php" class="login" method="post">
        <fieldset>
    ...
    <form action="/${idpId}/login.php/authn-pending" method="post">
    ...
    <form action="/${idpId}/login.php/no-authn-context" method="post">
        <fieldset>
    ...
    <form action="/${idpId}/login.php/authn-failure" method="post">
        <fieldset>
    ...
    <form action="/${idpId}/login.php/uplift-failed" method="post">
        <fieldset>
    ...
    <form action="/${idpId}/login.php/fraud-failure" method="post">
        <fieldset>
    ...
    <form action="/${idpId}/login.php/requester-error" method="post"">
    <fieldset>
