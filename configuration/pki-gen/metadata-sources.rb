...
hub_yaml = {
  ...
  'assertion_consumer_service_uri' => "http://#{ENV.fetch('EXTERNAL_HOST')}:40000/stub/sp/SAML2/SSO/Response",
  'organization' => { 'name' => 'Stub Sp', 'url' => 'http://localhost', 'display_name' => 'Stub Sp' },
...
Dir::chdir(output_dir) do
  ...
  idps.each do |name, id|
    yaml = idp_yaml.update(
      ...
      'entity_id' => "http://stub_idp.acme.org/#{id}/SSO/POST",
