<#-- @ftlvariable name="" type="stubidp.stubidp.views.EidasLoginPageView" -->
<div class="main">
    <div class="tabs">
        <ul>
            <li class="on">
    ...
    <form action="${eidasLoginResource}" class="login" method="post">
        <fieldset>
    ...
    <form action="${eidasAuthnFailureResource}" method="post">
        <fieldset>
