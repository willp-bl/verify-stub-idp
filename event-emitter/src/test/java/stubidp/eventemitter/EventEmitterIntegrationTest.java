...
public class EventEmitterIntegrationTest {
    ...
    public static void setUp() {
        ...
        injector = EventEmitterTestHelper.createTestConfiguration(CONFIGURATION_ENABLED,
                EventEmitterTestHelper.ACCESS_KEY_ID,
                EventEmitterTestHelper.ACCESS_SECRET_KEY,
                Regions.EU_WEST_2,
                URI.create(apiGatewayStub.baseUri().build().toString() + EventEmitterTestHelper.AUDIT_EVENTS_API_RESOURCE));
    ...
    public void shouldEncryptMessageUsingEventEncrypterAndSendToAPIGateway() throws Exception {
        ...
        final Event expectedEvent = anEventMessage().withDetailsField(EventDetailsKey.idp_entity_id, IDENTIY_PROVIDER_ENTITY_ID)
                                                    ...
                                                    .build();
        apiGatewayStub.register(EventEmitterTestHelper.AUDIT_EVENTS_API_RESOURCE, HttpResponse.HTTP_200.getStatusCode());
    ...
    public void shouldFailSilentlyWithIncorrectResource() throws JsonProcessingException {
        ...
        apiGatewayStub.register(EventEmitterTestHelper.AUDIT_EVENTS_API_RESOURCE_INVALID, HttpResponse.HTTP_404.getStatusCode());
    ...
    public void shouldFailSilentlyWithTimeout() throws JsonProcessingException {
        ...
        apiGatewayStub.register(EventEmitterTestHelper.AUDIT_EVENTS_API_RESOURCE, HttpResponse.HTTP_504.getStatusCode());
