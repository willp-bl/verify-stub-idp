...
import static stubidp.saml.utils.core.test.builders.AddressAttributeBuilder_1_1.anAddressAttribute;
import static stubidp.saml.utils.core.test.builders.AttributeStatementBuilder.anAttributeStatement;
import static stubidp.saml.utils.core.test.builders.GenderAttributeBuilder_1_1.aGender_1_1;
...
public class MatchingDatasetAttributeStatementBuilder_1_1 {
    ...
    private Optional<Attribute> currentAddressAttribute = Optional.ofNullable(anAddressAttribute().addAddress(AddressAttributeValueBuilder_1_1.anAddressAttributeValue().build()).buildCurrentAddress());
    ...
    public MatchingDatasetAttributeStatementBuilder_1_1 withCurrentAddress() {
        this.currentAddressAttribute = Optional.ofNullable(anAddressAttribute().addAddress(AddressAttributeValueBuilder_1_1.anAddressAttributeValue().build()).buildCurrentAddress());
        return this;
    }
    ...
    public MatchingDatasetAttributeStatementBuilder_1_1 addPreviousAddress() {
        this.previousAddressAttributes.add(anAddressAttribute().addAddress(AddressAttributeValueBuilder_1_1.anAddressAttributeValue().build()).buildPreviousAddress());
        return this;
    }
