...
import static acceptance.uk.gov.ida.verifyserviceprovider.services.ComplianceToolService.AUTHENTICATION_FAILED_ID;
...
public class AuthnFailedResponseAcceptanceTest {
    ...
    public static final MockMsaServer msaServer = new MockMsaServer();
