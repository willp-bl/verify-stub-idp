...
import acceptance.uk.gov.ida.verifyserviceprovider.Utils.MdsValueChecker;
...
import static acceptance.uk.gov.ida.verifyserviceprovider.builders.VerifyServiceProviderAppRuleBuilder.aVerifyServiceProviderAppRule;
import static acceptance.uk.gov.ida.verifyserviceprovider.services.ComplianceToolService.AUTHENTICATION_FAILED_WITH_NON_MATCH_SETTING_ID;
import static acceptance.uk.gov.ida.verifyserviceprovider.services.ComplianceToolService.FRAUDULENT_MATCH_RESPONSE_WITH_NON_MATCH_SETTING_ID;
import static acceptance.uk.gov.ida.verifyserviceprovider.services.ComplianceToolService.NO_AUTHENTICATION_CONTEXT_WITH_NON_MATCH_SETTING_ID;
import static acceptance.uk.gov.ida.verifyserviceprovider.services.ComplianceToolService.VERIFIED_USER_ON_SERVICE_WITH_NON_MATCH_SETTING_ID;
...
public class NonMatchingAcceptanceTest {
    ...
    public static VerifyServiceProviderAppExtension application = aVerifyServiceProviderAppRule()
            .withMockMsaServer(msaServer)
            .build();
            
    public static VerifyServiceProviderAppExtension applicationWithEidasEnabled  = aVerifyServiceProviderAppRule()
            .withEidasEnabledFlag(true)
            .build();

    public static VerifyServiceProviderAppExtension applicationWithEidasDisabled  = aVerifyServiceProviderAppRule()
