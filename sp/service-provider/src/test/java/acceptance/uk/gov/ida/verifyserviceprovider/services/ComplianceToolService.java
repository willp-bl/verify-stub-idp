package acceptance.uk.gov.ida.verifyserviceprovider.services;
...
import static acceptance.uk.gov.ida.verifyserviceprovider.builders.ComplianceToolV2InitialisationRequestBuilder.aComplianceToolV2InitialisationRequest;
...
public class ComplianceToolService {
    ...
    public void initialiseWith(Entity<Map<String, Object>> initialisationRequest) {
    ...
    public void initialiseV2With(Entity<Map<String, Object>> initialisationRequest) {
        Response complianceToolResponse = client
