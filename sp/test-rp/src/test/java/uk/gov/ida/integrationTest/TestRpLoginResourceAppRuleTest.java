...
class TestRpLoginResourceAppRuleTest extends IntegrationTestHelper {
    ...
    @Test
    void shouldHandleNoMatchWithSuccessStatusForLegacyNonSimpleProfile() throws Exception {
    ...
    @Test
    void shouldHandleNoMatchWithResponderStatusForNonSimpleProfile() throws Exception {
        final URI uri = wantsHubSignatureTestRp.uri(LOGIN_PATH);
    ...
    @Test
    void shouldHandleNoMatchWithResponderStatusForSimpleProfile() throws Exception {
    ...
    @Test
    void shouldRedirectToSuccessPageWhenResponseEnvelopeIsExpectedlySigned() throws Exception {
        final URI uri = wantsHubSignatureTestRp.uri(LOGIN_PATH);
    ...
    @Test
    void shouldNotRedirectToSuccessPageWhenResponseEnvelopeIsUnexpectedlyNotSigned() throws Exception {
        final URI uri = wantsHubSignatureTestRp.uri(LOGIN_PATH);
    ...
    @Test
    void shouldRedirectToSuccessPageWhenResponseEnvelopeIsUnexpectedlySigned() throws Exception {
        final URI uri = wantsNoHubSignatureTestRp.uri(LOGIN_PATH);
    ...
    @Test
    void shouldRedirectToSuccessPageWhenResponseEnvelopeIsExpectedlyNotSigned() throws Exception {
        final URI uri = wantsNoHubSignatureTestRp.uri(LOGIN_PATH);
    ...
    @Test
    void shouldRedirectToSuccessPageWhenResponseEnvelopeIsSigned() throws Exception {
        final URI uri = wantsHubSignatureTestRp.uri(LOGIN_PATH);
